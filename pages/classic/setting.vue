...
">
                            <v-avatar size="100" v-for="(chip,index) in chips" :key="index">
                                <v-img :src="chip.img">
                                    <input type="number" min="10" max="10000" :style="chip.title !== 'black' ? 'color :black': 'color :white'" :readonly="!isShow && index == isOpen ? true:false" :class="isShow && index == isOpen ? 'btn-setchipsedit':'btn-setchips'" v-model="chip.price" />
                                </v-img>
