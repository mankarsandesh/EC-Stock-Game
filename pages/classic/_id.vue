        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">{{$t('msg.totalbet')}} : <span class="text-waring">{{this.betData.betdetails.length}}</span></td>
                        <td colspan="2" class="text-left">{{$t('msg.totalamount')}} : <input class="text-success total" :value="sumTotalAll"></td>
                    </tr>
                </table>
            </v-card-text>
            <v-card-actions>
