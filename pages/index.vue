...
<div>
    <div class="bg-primary">
        <div class="row d-flex justify-center align-center">
            <h1 class="text-center">Choose Game ModeDer</h1>
        </div>
    ...
    methods: {
        ...
        getProgress() {
            let width = 100,
                ...
                .timing, // The PerformanceTiming interface represents timing-related performance information for the given page.
