...
<div class="p-relative">
    ...
    <v-layout row>
        <popper :disabled="checkFooterBet" v-for="data in lastDigit" :key="data.rule" class="w20" trigger="click" :options="{
            ...
            <v-btn class="align_button4" @click="betButtonClick('lastdigit-'+data.rule)" slot="reference">
                <showChipAmount size="50px" :amount="getAmountMultiGameBet({stockId:stockName ,gameRule:'lastdigit-'+data.rule})"></showChipAmount>
    ...
    <v-layout row>
        <popper :disabled="checkFooterBet" v-for="data in bothDigit" :key="data.rule" class="w16" trigger="click" :options="{
            ...
            <v-btn class="align_button5" @click="betButtonClick('bothdigit-'+data.rule)" slot="reference">
                <showChipAmount size="50px" :amount="getAmountMultiGameBet({stockId:stockName ,gameRule:'bothdigit-'+data.rule})"></showChipAmount>
    ...
    <v-layout row>
        <popper :disabled="checkFooterBet" v-for="data in twoDigit" :key="data.rule" class="w16" trigger="click" :options="{
            ...
            <v-btn class="align_button5" @click="betButtonClick('twodigit-'+data.rule)" slot="reference">
                <showChipAmount size="50px" :amount="getAmountMultiGameBet({stockId:stockName ,gameRule:'twodigit-'+data.rule})"></showChipAmount>
    ...
    <v-layout row>
        <span class="w20">
            <v-btn class="align_button4" @click="btnNumber('first')">
                <showChipAmount size="50px" :amount="getAmountBetSpecificNumber({stockId:stockName ,gameRule:'firstdigit'})"></showChipAmount>
        ...
        <span class="w20">
            <v-btn class="align_button4" @click="btnNumber('both')">
                <showChipAmount size="50px" :amount="getAmountBetSpecificNumber({stockId:stockName ,gameRule:'bothdigit'})"></showChipAmount>
        ...
        <span class="w20">
            <v-btn class="align_button4" @click="btnNumber('two')">
                <showChipAmount size="50px" :amount="getAmountBetSpecificNumber({stockId:stockName ,gameRule:'twodigit'})"></showChipAmount>
    ...
    <v-layout row class="container-btn-small">
        <popper :disabled="checkFooterBet" v-for="(n,index) in 10" :key="'firstdigit-'+index" trigger="click" :options="{
            ...
            <div class="popper">
                <betModal :stockName="stockName" :loop="getLoop($route.params.id)" :betId="'firstdigit-'+index" :payout="payout_09"></betModal>
            </div>
        ...
        <popper :disabled="checkFooterBet" v-for="(n,index) in 10" :key="'lastdigit-'+index" trigger="click" :options="{
            ...
            <div class="popper">
                <betModal :stockName="stockName" :loop="getLoop($route.params.id)" :betId="'lastdigit-'+index" :payout="payout_09"></betModal>
            </div>
        ...
        <popper :disabled="checkFooterBet" v-for="(n,index) in 19" :key="'bothdigit-'+index" trigger="click" :options="{
            ...
            <div class="popper">
                <betModal :stockName="stockName" :loop="getLoop($route.params.id)" :betId="'bothdigit-'+index" :payout="payout_18"></betModal>
            </div>
        ...
        <popper :disabled="checkFooterBet" v-for="(n,index) in 100" :key="index < 10 ? 'twodigit-0' + index :'twodigit-'+index" trigger="click" :options="{
            ...
            <div class="popper">
                <betModal :stockName="stockName" :loop="getLoop($route.params.id)" :betId="index < 10 ? 'twodigit-0' + index :'twodigit-'+index" :payout="payout_99"></betModal>
            </div>
