...
<div>
    ...
    <input type="file" id="fileInput" style="display: none" ref="imageFile" accept="image/*" @change="ResizeImage">

    <input type="button" value="Resize Image" hidden id="Submit" @click="ResizeImage" /><br>
